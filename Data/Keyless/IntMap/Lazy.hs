...
-}
module Data.Keyless.IntMap.Lazy (KeylessIntMap) where
...
instance Keyless (KeylessIntMap a) where

  type Elem (KeylessIntMap a) = a
...
instance FKeyless KeylessIntMap a where
